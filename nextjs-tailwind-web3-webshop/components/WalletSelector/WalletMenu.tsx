...
import WalletIcon from "../../public/images/icons/WalletIcon"
...
export default function WalletMenu() {
    ...
    : [
        {
          ...
          icon: (
            <img
              src="/images/walletIcons/metamask.png"
              height={20}
              width={20}
            />
          ),
        },
        {
          ...
          icon: (
            <img
              src="/images/walletIcons/walletConnectIcon.png"
              height={20}
              width={20}
            />
          ),
  ...
  const switchWallet = async (arg: string) => {
    ...
    if (arg === "WalletConnect") {
      ...
      try {
        walletConnect.activate().catch((error) => console.log(error))
      } catch (error) {
